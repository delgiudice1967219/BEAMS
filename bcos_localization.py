...
def compute_attributions(model, test_img, zeroshot_weight, smooth=0, alpha_percentile=99.5):
    """
...
def get_bcos_heatmap(model, image, text_prompt, clip_model=None, device=None, return_raw=False):
    """
