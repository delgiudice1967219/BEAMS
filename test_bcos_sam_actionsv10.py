...
# --- 4. MAIN PIPELINE ---
CTX_RADIUS = 18  # quanto allarghi la persona
ALPHA_CTX = 0.7  # quanto pesa il contesto rispetto alla persona
...
def main():
    ...
    for idx, person_mask in enumerate(valid_masks):
        ...
        ctx_mask = dilate_person_mask(person_mask, radius_px=CTX_RADIUS)
