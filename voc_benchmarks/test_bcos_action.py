...
IMG_PATH = r"C:/Users/xavie/Desktop/Universitá/2nd year/AML/BCos_object_detection/data/VOCdevkit/VOC2012/JPEGImages/2011_003406.jpg"
TARGET_CLASS = "person jumping"

OUTPUT_DIR = "single_image_viz"
...
def main():
    ...
    target_weight = get_target_weight(clip_model, TARGET_CLASS, DEVICE)
    ...
    save_path = os.path.join(OUTPUT_DIR, "single_image_result.png")
